...
export default function Stats() {
  ...
  return (
    <div ref={sectionRef} className="container mx-auto px-5 mt-5">
      <div className="glass-panel rounded-[30px] p-8 text-black">

        {/* Four stats in a responsive grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-4">
              <h2 className="text-5xl md:text-6xl font-bold text-green-600" style={{ color: "#10b981" }}>
                $270K+
              </h2>
              <p className="text-gray-600 uppercase tracking-widest text-sm leading-tight">
            ...
            <ProgressBar targetWidth="75%" isInView={isInView} />
          </div>
        ...
        <div className="border-t border-gray-100 pt-6 flex justify-center">
          <button
            ...
            className="btn-primary flex items-center justify-center gap-2 uppercase font-bold text-base cursor-pointer px-10"
          >
